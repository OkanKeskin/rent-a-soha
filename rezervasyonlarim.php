...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="css/rezervasyonlarım.css" />
  ...
  <!-- mavi Bölümü Başlangıç --><div class="kirmizi_bolum" id="kirmizi_bolum">
         ...
         <!-- Sağdaki Yazı Bölümü Başlangıç -->   <div class="sagdaki_yazi_bolumu" id="sagdaki_yazi_bolumu">
                
                <p>Rezervasyonlarınıza rezervsayon numarası ve soyadınızı girerek iptal edebilir veya güncelleyebilirsiniz.</p>
                <div style="margin-top: 40px;">
                  <p style="color: rgb(255, 0, 0);" id="yazi_yok"></p>
                </div>
        ...
        <!-- Beyaz Bölüm Başlangıç -->  <div class="beyaz_bolum" id="beyaz_bolum">
          <!-- Sağdaki Yazı Bölümü Başlangıç --><div class="buton_oncesi" id="buton_oncesi">
              <div class="rezervasyon_ara" id="rezervasyon_ara">
                  <img class="rezervasyon_resim" src="assets/logo.png" alt="">

                <form action="./backend/rezervasyonkontrol.php" method="POST" id="form">
                    <div class="rezervasyon_no" id="rezervasyon_no">
                    <div class="mb-3">
                      <label for="rezervasyon" class="form-label">Rezervasyon Numarası</label>
                      <input type="text" class="form-control" id="rezervasyon_numara" required  name="rezno" minlength="4">
                      
                     
                    </div>
                </div>
                <div class="rezervasyon_soyad" id="rezervasyon_soyad">
                    <div class="mb-3">
                      <label for="rezervasyon" class="form-label">Soyadı</label>
                      <input type="text" class="form-control" required id="rezervasyon_soyadi" name="soyad" >
                      
                    </div>
                </div>
                    <input id="ara" class="btn btn-outline-primary" type="submit" value="ARA">
                    <div id="hata1"></div>
                    <div id="hata2" ></div>
                  </form>
            </div>
