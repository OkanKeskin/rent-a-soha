...
$sql = "SELECT * FROM arac as a inner join arac_kategori as ktg on a.kat_id=ktg.kat_id where a.kat_id=5";
...
<?php include "NavBar.php"   ?>
        ...
        <div class="jumbotron">
        <h1 class="display-4">Prestij Araçlar</h1>
                ...
                <div class="arac_bolumu_kartli_yapi"  > 
                    ...
                    <div class="card" >
                        <div class="card-header" >
                            ...
                            <div class="arac_sinif"> <p><?php echo $row['kat_adi'] ;  ?></p></div>
                        ...
                        <div  class="resim_alti_bilgi"> <!--RESİM ALTI BİLGİLENDİRME BAŞLANGIÇ-->
                            ...
                            <div class="arac_ozellikleri" ><!--ARAÇ ÖZELLİKLERİ BAŞLANGIÇ-->
