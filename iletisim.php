  ...
  <header>
    ...
    <div class="container">
      ...
      <div class="İletişim_header">
        ...
        <div class="headyazi">
            <p>Her türlü soru, görüş ve önerinizi iletişim formu ile bize gönderebilirsiniz.</p>
            <p class="smal">* Geri dönüş sağlanabilmesi için gereken zorunlu alanlardır.</p>
        </div>
        ...
        <div class="orta">
          <div class="left">
            ...
            <form action="./backend/iletisim.php" method="POST" style="margin-bottom:20px; border-right: 1px solid #02b8dd";>
              ...
              <div2>
                <label for="email2">E-Posta Adres Onay</label><br>
                <input required id="email2" type="email"> <br>
              </div2>
          ...
          <div class="right">
            ...
            <div class="right_tel">
              ...
              <p>Tüm soruların ve taleplerin için aşağıdaki numaradan ve mail adresinden bizlere ulaşabilirsin.</p>
              </div>
              <div class="yeterartik">
                <div class="biziara">
                <h4>Bizi Ara</h4>
                <p>0532 762 1221</p>
              </div>

              <div class="mailgonder">
                <h4>Bize Mail At</h4>
                <p>rentasoha@gmail.com</p>
              </div>
              </div>
            ...
            <div class="right_sosyal">
              <div class="adress" style="padding: 9% 10%;">
                <a href="">
                  <svg
