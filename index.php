...
<html lang="en">
  <head>
    ...
    <style>
      /* Burada resimlerin olduğu bölümlerin classları var */
      .resimlim{
        background-image: url("assets/bg.jpeg");
      }
      .sag{
        background-image: url("assets/altbg.jpeg");
      }
    </style>
  </head>
  <body>
    <div class="container">
      ...
      <div class="header-bottom">
        <h1>Acil araç lazım ve hiçbir yerde bulamıyor musun?</h1>
        <h2>Aradığın yer tam da burası</h2>
      </div>
      <!-- HEADER BOTTOM-->

      <!-- Rezerve -->
      <div style="width: 100%; height: 440px;" class="content resimlim">
        <button id="button" onclick="deneme()">Rezerve Et</button>
        <section id="section" style="display: none">
          <div class="rezerve">
            <div class="rez">
              <select class="select" id="select">
                <option value="konfor_sinif">Konfor Sınıf</option>
                <option value="ekonomik_sinif">Ekonomik Sınıf</option>
                <option value="luks_araclar">Lüks Sınıf</option>
                <option value="premium_sinif">Premium Sınıf</option>
                <option value="prestij_sinif" selected>Prestij Sınıf</option>
              </select>
              <!-- <input type="button" value="Rezerve Et" /> -->
              <a href="#" id="rezerv">Rezerve Et</a>
            </div>
          </div>
        </section>
      </div>
    ...
    <!-- NASIL ÇALIŞIR -->
    <div class="why-work" id="why-work">
      <div class="row h-100">
        <h2>Online Araç Kiralama Nasıl Çalışır?</h2>
        <div class="col-6 sol"> 
          <div class="part">
            <h4>1. Aracını Seç</h4>
            <p>Size Sunduğumuz birçok marka ve model araçtan en uygununu seçersiniz</p>
          </div>
          <div class="part">
            <h4>2. Sisteme Giriş</h4>
            <p>Üyelik bilgilerinizi sisteme girerek veya yeni üyemiz olarak sisteme girersiniz ve bilgileriniz kontrol edilir</p>
          </div>
          <div class="part">
            <h4>3. Sözleşme Onay</h4>
            <p>Kendi sözleşmenizi ayarlar ve aracı, tarihi seçersiniz.</p>
          </div>
          <div class="part">
            <h4>4. Artık Hazır</h4>
            <p>Vee artık aracınız hazır. Teslimat günü ve saatinde aracınıza kavuşabilirsiniz.</p>
          </div>
        </div>
        <div class="col-6 sag"></div>
      </div>
    </div>
    <!-- NASIL ÇALIŞIR -->
     ...
     <div class="footer-top">
      ...
      <div class="footer-nav">
        <ul>
          ...
          <li><a href="./zadmin/panel.php">Admin Panel</a></li>
        </ul>
        <ul>
          <h6>Bilgi Bankası</h6>
