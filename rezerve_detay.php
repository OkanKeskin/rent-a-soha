...
<html lang="en">
  ...
  <?php
       ...
       $sql = "SELECT*FROM rezervasyon as r inner join kullanici as k on r.kul_id=k.kul_id inner join arac as a on r.arac_id=a.arac_id inner join arac_kategori as akg on a.kat_id=akg.kat_id  where r.rez_id='".$rezid."' and k.soyadi='".$soyad."'";
...
?>
    ...
    <link rel="stylesheet" href="css/rezerve_detay.css" />
...
<div class="card" style="  border-radius:25px 25px 25px 25px;">
    ...
    <div class="card-body">
        ...
        <div class="button1">
            ...
            <button id="guncelle" class="btn btn-primary"><a id="guncelle" style="text-decoration:none; color: white;" href="./rezerve_guncelle.php">Guncelle</a></button>
        </div>
        <div class="button2">
        

          <button  class="btn btn-danger"><a id="iptal" style="text-decoration:none;color: white;" href="./backend/rezerve_sil.php">İptal Et</a></button>
      </div>
        <!--BUTON BİTİŞ-->
    </div>
</div>
  ...
  let text;
    if (confirm("Rezervasyonunuzu iptal etmek istediğinizden emin misiniz ?") == true) {
      text = alert("Rezervasyonunuz Başarıyla İptal Edildi!");
document.location.href = './backend/rezerve_sil.php';
} 
