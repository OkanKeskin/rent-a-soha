...
$sql = "SELECT * FROM arac as a inner join arac_kategori as ktg on a.kat_id=ktg.kat_id where a.kat_id=3 ";
...
<?php include "NavBar.php"   ?>
        ...
        <div class="jumbotron">
        <h1 class="display-4">Premium Araçlar</h1>
