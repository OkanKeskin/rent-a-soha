...
<html lang="en">
  ...
  <?php
       ...
       $sql = "SELECT*FROM rezervasyon as r inner join kullanici as k on r.kul_id=k.kul_id inner join arac as a on r.arac_id=a.arac_id   where r.rez_id='".$rezid."' and k.soyadi='".$soyad."'";
       ...
       $_SESSION["teslim_etme_tarihi"]=$teslim_et;
       
       
       $_SESSION["teslim_alma_ofisi"]=$row["teslim_alma_ofisi"];

       $_SESSION["teslim_etme_ofisi"]=$row["teslim_etme_ofisi"];

       $_SESSION["teslim_etme_saati"]=$row["teslim_etme_saati"];
...
?>
    ...
    <link rel="stylesheet" href="css/rezerve_guncelle.css" />
          ...
          <ul>
            ...
            <li>
              ...
              <ul class="acilir">
                ...
                <hr />
                <li>
                  <a href="ekonomik_sinif.html">Ekonomik Sınıf Araçlar</a>
                </li>
  ...
  <!-- mavi Bölümü Başlangıç --><div class="kirmizi_bolum" id="kirmizi_bolum">
          ...
          <!-- Güncelleme butonu tıklanış sonrası-->
          
          <div class="guncelleme">
            <br>
            <span ><h2 style="color: white;"><?php echo $_SESSION["adi"]." ".$_SESSION["soy"]   ?></h2></span>
          
            <div class="tablo">
                <form action="./backend/rezerve_guncelle_islem.php" method="POST">
            <table  class="table table-inverse text-white ">
              ...
              <tr>
                ...
                <td ><select id="alis_ofisi" class="form-control" name="teslim_alma_ofisi" value="<?php  $_SESSION["teslim_alma_ofisi"]  ?>">
              ...
              <th><label for="my-select">Teslim Etme Ofisi</label></th>
                <td ><select id="iade_ofisi" class="form-control" name="teslim_etme_ofisi" value="<?php  $_SESSION["teslim_etme_ofisi"]  ?>">
                <option value="1">İstanbul Havalimanı</option>
                  <option  value="2">Çorlu Havalimanı</option>
                  <option  value="3">Kırklareli/Merkez</option>
                  <option  value="4">Kırklareli/Lüleburgaz</option>
              ...
              <tr>
                ...
                <td > <input type="date" class="form-control" name="teslim_alma_tarihi" value="<?php echo $_SESSION["rez_tar"]  ?>" ></td>
                <th>Teslim Etme Tarihi</th>
                <td > <input type="date" class="form-control" name="teslim_etme_tarihi" value="<?php echo $_SESSION["teslim_etme_tarihi"]  ?>" ></td>
              </tr>
              <tr>
                <th>Teslim Alma Saati</th>
                <td ><input type="time" class="form-control" id="time_al" name="teslim_alma_saati" value="<?php  echo $_SESSION["teslim_alma_saati"]  ?>"></td>
                <th>Teslim Etme Saati</th>
                <td ><input type="time" class="form-control" id="time_et" name="teslim_etme_saati" value="<?php echo  $_SESSION["teslim_etme_saati"]  ?>"></td>
              </tr>
          ...
          <div class="butonlar"> <!--BUTON BAŞLANGIÇ-->
            ...
            <input id="guncelleme" type="submit" name="gonder" class="btn btn-light" value="Güncelle">

        </div> <!--BUTON bitiş-->
        </form>
      </div>    <!-- Güncelleme butonu tıklanış sonrası bitiş-->

      </div>



    </div>  <!-- mavi Bölümü bitiş -->
    </div><!-- Rezervasyon Bölümü bitiş -->
